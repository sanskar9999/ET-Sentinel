...
export const VARIANT_META: { full: VariantMeta;[k: string]: VariantMeta } = {
  ...
  et: {
    title: 'ET Sentinel - AI-Native Indian Business Intelligence Dashboard',
    description: 'AI-powered Indian business news dashboard with causal intelligence, story arc tracking, market predictions, and real-time analysis of Indian economy, markets, startups, and policy.',
    keywords: 'Indian business news, AI news dashboard, NIFTY, Sensex, BSE, NSE, Indian markets, RBI, SEBI, Indian startups, causal intelligence, story arc, market predictions, economic analysis, Indian economy, fintech India',
    url: 'https://et.worldmonitor.app/',
    siteName: 'ET Sentinel',
    shortName: 'ETSentinel',
    subject: 'AI-Native Indian Business and Economic Intelligence',
    classification: 'AI News Dashboard, Indian Markets, Business Intelligence',
    categories: ['news', 'finance', 'business'],
    features: [
      'Causal Intelligence Engine',
      'Story Arc Tracking with Predictions',
      'AI-powered India Business Briefings',
      'Real-time Indian market tracking',
      'RBI & SEBI policy monitoring',
      'Indian startup ecosystem tracking',
      'Commodity price analysis',
      'Self-correcting prediction tree',
      'Hindi language support',
      'India-focused map visualization',
    ],
  },
};
