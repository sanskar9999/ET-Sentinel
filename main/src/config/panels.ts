...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  'india-business': { name: 'India Business', enabled: true, priority: 2 },
  'india-tech': { name: 'India Tech', enabled: true, priority: 2 },
  'india-policy': { name: 'India Policy', enabled: true, priority: 2 },
  'global-impact': { name: 'Global Impact', enabled: true, priority: 2 },
};
...
// ============================================
// ET SENTINEL VARIANT (Indian Business Intelligence)
// ============================================
const ET_PANELS: Record<string, PanelConfig> = {
  map: { name: 'India Business Map', enabled: true, priority: 1 },
  'live-news': { name: 'Business Headlines', enabled: true, priority: 1 },
  'story-arc': { name: 'Causal Intelligence', enabled: true, priority: 1 },
  'india-business': { name: 'India Business', enabled: true, priority: 1.2 },
  markets: { name: 'Markets', enabled: true, priority: 1.3 },
  'india-tech': { name: 'India Startup & Tech', enabled: true, priority: 1.4 },
  'india-policy': { name: 'RBI, SEBI & Policy', enabled: true, priority: 1.5 },
  commodities: { name: 'Metals & Materials', enabled: true, priority: 1.6 },
  crypto: { name: 'Crypto', enabled: true, priority: 1.7 },
  'global-impact': { name: 'Global Impact on India', enabled: true, priority: 1.8 },
  ai: { name: 'AI Insights', enabled: true, priority: 2 },
  'world-clock': { name: 'World Clock', enabled: true, priority: 2 },
  monitors: { name: 'My Monitors', enabled: true, priority: 2 },
};

const ET_MAP_LAYERS: MapLayers = {
  gpsJamming: false, satellites: false, conflicts: false, bases: false,
  cables: true, pipelines: false, hotspots: false, ais: false,
  nuclear: false, irradiators: false, sanctions: false, weather: true,
  economic: true, waterways: true, outages: true, cyberThreats: false,
  datacenters: false, protests: false, flights: false, military: false,
  natural: true, spaceports: false, minerals: false, fires: false,
  ...
  stockExchanges: true, financialCenters: true, centralBanks: true,
  ...
  tradeRoutes: true, iranAttacks: false, ciiChoropleth: false, dayNight: false,
  miningSites: false, processingPlants: false, commodityPorts: false,
  webcams: false, weatherRadar: false, diseaseOutbreaks: false, radiationWatch: false,
};

const ET_MOBILE_MAP_LAYERS: MapLayers = {
  gpsJamming: false, satellites: false, conflicts: false, bases: false,
  cables: false, pipelines: false, hotspots: false, ais: false,
  nuclear: false, irradiators: false, sanctions: false, weather: false,
  economic: true, waterways: false, outages: true, cyberThreats: false,
  datacenters: false, protests: false, flights: false, military: false,
  natural: true, spaceports: false, minerals: false, fires: false,
  ucdpEvents: false, displacement: false, climate: false,
  startupHubs: false, cloudRegions: false, accelerators: false,
  techHQs: false, techEvents: false,
  stockExchanges: true, financialCenters: false, centralBanks: true,
  commodityHubs: false, gulfInvestments: false,
  positiveEvents: false, kindness: false, happiness: false,
  speciesRecovery: false, renewableInstallations: false,
...
export const VARIANT_PANEL_OVERRIDES: Partial<Record<string, Partial<Record<string, Partial<PanelConfig>>>>> = {
  ...
  et: {
    map: { name: 'India Business Map' },
    'live-news': { name: 'Business Headlines' },
    insights: { name: 'AI India Brief' },
  },
};
...
export const PANEL_CATEGORY_MAP: Record<string, { labelKey: string; panelKeys: string[]; variants?: string[] }> = {
  ...
  // ET Sentinel variant (Indian Business)
  etIndiaBusiness: {
    labelKey: 'header.panelCatIndiaBusiness',
    panelKeys: ['india-business', 'markets', 'india-tech', 'india-policy', 'commodities'],
    variants: ['et'],
  },
  etIntelligence: {
    labelKey: 'header.panelCatCausalIntel',
    panelKeys: ['story-arc', 'insights'],
    variants: ['et'],
  },
  etGlobal: {
    labelKey: 'header.panelCatGlobalContext',
    panelKeys: ['global-impact', 'ai', 'crypto', 'world-clock', 'monitors'],
    variants: ['et'],
  },
};
