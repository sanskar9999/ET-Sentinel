...
export const SOURCE_TIERS: Record<string, number> = {
  ...
  // Tier 2 - Indian Business Sources (ET variant)
  'ET Markets': 2,
  'Mint': 2,
  'MoneyControl': 2,
  'Business Standard': 2,
...
// ET variant feeds (Indian Business)
import { FEEDS as ET_FEEDS } from './variants/et';
...
export const SOURCE_REGION_MAP: Record<string, { labelKey: string; feedKeys: string[] }> = {
  ...
  india: { labelKey: 'header.sourceRegionIndia', feedKeys: ['india-business', 'india-tech', 'india-policy', 'markets'] },
};
...
export const DEFAULT_ENABLED_SOURCES: Record<string, string[]> = {
  ...
  'india-business': ['ET Markets', 'Mint', 'MoneyControl'],
  markets: ['NSE India', 'ET Markets Live', 'Reuters India'],
  'india-tech': ['Inc42', 'YourStory', 'Entrackr'],
  'india-policy': ['RBI News', 'SEBI Updates', 'India Budget'],
  crypto: ['Crypto India'],
  'global-impact': ['US Fed Impact', 'China Trade', 'Global Markets'],
};
